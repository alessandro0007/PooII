...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        string connectionString = "Data Source=CGR_LAB15_MAQ16.\\SQLEXPRESS;Initial Catalog=bdAtacado;User=usrAtacado;Password=senha123;TrustServerCertificate=True;";
        ...
        {
            Console.WriteLine($" {item.CodigoEstado} - {item.UF} - {item.Nome} - {item.CodigoRegiao}");
        }
